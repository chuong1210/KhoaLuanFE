...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-sunrise text-white shadow-orange-md hover:opacity-90',
        destructive:
          'bg-orange-deep text-white hover:bg-orange-terracotta',
        outline:
          'border-2 border-primary text-primary hover:bg-primary hover:text-white',
        secondary:
          'bg-gradient-warm-peach text-black hover:opacity-90',
        ghost:
          'text-primary hover:bg-orange-apricot',
        link:
